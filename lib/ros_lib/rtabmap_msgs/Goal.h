#ifndef _ROS_rtabmap_msgs_Goal_h
#define _ROS_rtabmap_msgs_Goal_h
...
namespace rtabmap_msgs
{
  ...
  class Goal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rtabmap_msgs/Goal"; };
    virtual const char * getMD5() override { return "70f8a16a321d4ec76904a9989a8798b7"; };
