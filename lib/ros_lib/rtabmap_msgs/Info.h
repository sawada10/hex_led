#ifndef _ROS_rtabmap_msgs_Info_h
#define _ROS_rtabmap_msgs_Info_h
...
namespace rtabmap_msgs
{
  ...
  class Info : public ros::Msg
  {
    public:
      ...
      typedef rtabmap_msgs::MapGraph _odom_cache_type;
    ...
    virtual const char * getType() override { return "rtabmap_msgs/Info"; };
