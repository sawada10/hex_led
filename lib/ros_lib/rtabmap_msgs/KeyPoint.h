#ifndef _ROS_rtabmap_msgs_KeyPoint_h
#define _ROS_rtabmap_msgs_KeyPoint_h
...
namespace rtabmap_msgs
{
  ...
  {
    public:
      typedef rtabmap_msgs::Point2f _pt_type;
      _pt_type pt;
    ...
    virtual const char * getType() override { return "rtabmap_msgs/KeyPoint"; };
