...
namespace grid_map_msgs
{
  ...
  class GridMap : public ros::Msg
  {
    ...
    GridMap():
      ...
      basic_layers_length(0), st_basic_layers(), basic_layers(nullptr),
    ...
    virtual const char * getType() override { return "grid_map_msgs/GridMap"; };
    virtual const char * getMD5() override { return "95681e052b1f73bf87b7eb984382b401"; };
