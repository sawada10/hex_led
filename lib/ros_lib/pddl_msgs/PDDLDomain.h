...
namespace pddl_msgs
{
  ...
  class PDDLDomain : public ros::Msg
  {
    ...
    PDDLDomain():
      ...
      constants_length(0), st_constants(), constants(nullptr),
      predicates_length(0), st_predicates(), predicates(nullptr),
      actions_length(0), st_actions(), actions(nullptr),
      functions_length(0), st_functions(), functions(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "pddl_msgs/PDDLDomain"; };
    virtual const char * getMD5() override { return "1db1abf7dbdf3e62fc55c75c4b365253"; };
