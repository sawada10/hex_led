...
namespace pddl_msgs
{
  ...
  class PDDLProblem : public ros::Msg
  {
    ...
    PDDLProblem():
      ...
      initial_length(0), st_initial(), initial(nullptr),
      goal(""),
      metric("")
    {
    }
    ...
    virtual const char * getType() override { return "pddl_msgs/PDDLProblem"; };
    virtual const char * getMD5() override { return "dfd9bdd094d91245128f960694763882"; };
