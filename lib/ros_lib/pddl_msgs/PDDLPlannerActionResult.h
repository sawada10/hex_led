...
namespace pddl_msgs
{
  ...
  class PDDLPlannerActionResult : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "pddl_msgs/PDDLPlannerActionResult"; };
    virtual const char * getMD5() override { return "23505e01fe89e9bdbc26929cfac80648"; };
